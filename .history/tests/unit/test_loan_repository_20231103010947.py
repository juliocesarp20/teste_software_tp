...
def test_create_loan_with_invalid_amount(loan_repository_fixture,user_repository_mock):
    user_id = 1
    amount = -100 
    interest_rate = 0.1
    term_months = 12
...
def test_get_loans_by_user_id_with_no_loans(loan_repository_fixture,user_repository_mock):
    user_id = loan_repository_fixture()
