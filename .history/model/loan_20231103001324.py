class Loan:
    ...
    def pay_off_remaining_months(self):
        ...
        # Calculate the total remaining balance including interest
        total_remaining_balance = self.remaining_balance
        for _ in range(self.term_months - self.current_month):
            monthly_interest = total_remaining_balance * (self.interest_rate / 12)
            total_remaining_balance += monthly_interest

        # Pay off the total remaining balance
        self.remaining_balance = 0
