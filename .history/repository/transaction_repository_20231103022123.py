...
class TransactionRepository:
    ...
    def execute_and_save(self, sender_id, receiver_id, amount, currency):
        ...
        amount_in_account_currency = amount / sender_account.currency.value

        print(amount_in_account_currency = amount / sender_account.currency.value)

        self.user_repository.withdraw_funds(sender_id, amount_in_account_currency)

        amount_in_receiver_currency = amount_in_account_currency * receiver_account.currency.value
